sap.ui.define([
	...
	return Controller.extend("sap.ui.demo.fiori2.controller.confirmedOrdersV", {
			onInit: function () {
				...
				var oFilter=[];
				oFilter.push(new sap.ui.model.Filter('IvStatus', sap.ui.model.FilterOperator.EQ, '3'));
				oModel.read("/zgetordersbystatus3_ocaSet",{filters:oFilter,
					success:function(data){
						...
						var rejLen=data.results.length.toString();
						var oViewModel = new JSONModel({rejLen: rejLen});
